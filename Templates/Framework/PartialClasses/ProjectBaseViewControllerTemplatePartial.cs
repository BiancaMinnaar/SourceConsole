...
{
    public partial class ProjectBaseViewControllerTemplate : ITemplate<PreSetupTemplateModel>
    {
        ...
        public string FullProjectFileName => this.GetFullProjectFileName<ProjectBaseViewControllerTemplate, PreSetupTemplateModel>();
